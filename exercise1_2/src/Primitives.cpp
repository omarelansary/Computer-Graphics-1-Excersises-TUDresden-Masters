...
void CreateCube(HEMesh& mesh)
{
	...
	//cube ==> 6 faces (counter clock-wise)
	mesh.add_face(vhandles[0], vhandles[1], vhandles[2], vhandles[3]);
	mesh.add_face(vhandles[3], vhandles[7], vhandles[4], vhandles[0]);
	mesh.add_face(vhandles[6], vhandles[2], vhandles[1], vhandles[5]);
	mesh.add_face(vhandles[4], vhandles[7], vhandles[6], vhandles[5]);
	mesh.add_face(vhandles[0], vhandles[4], vhandles[5], vhandles[1]);
	mesh.add_face(vhandles[2], vhandles[6], vhandles[7], vhandles[3]);
